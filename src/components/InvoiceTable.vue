...
// Pay-Trigger mit 5s Abbruchlogik
...
.search-box input { 
  ...
  border-radius: 12px; width: 300px; outline: none; transition: 0.2s;
}
...
.status-action-btn {
  background: rgba(0, 188, 212, 0.05); border: 1px solid #1c2128; color: #00bcd4;
